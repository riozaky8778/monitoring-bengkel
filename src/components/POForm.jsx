        ...
        <div className="modal-body">
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              ...
              <select className={`form-input${errors.KETERANGAN ? ' error' : ''}`} value={po.KETERANGAN || ''} onChange={e => { setPo(p => ({ ...p, KETERANGAN: e.target.value })); setErrors(er => ({...er, KETERANGAN:''})); }}>
              ...
              <>
                ...
                {items.map((item, i) => (
                  <div className="item-row" key={i}>
                    ...
                    <button className="btn btn-sm" style={{ padding: '4px 7px', color: 'var(--red-t)', borderColor: 'transparent', background: 'none' }} onClick={() => removeItem(i)} disabled={items.length === 1}>×</button>
                  </div>
                ))}
